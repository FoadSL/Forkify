...
class RecipeView extends View {
  ...
  addHandlerAddBookmark(handler) {
    // We need to use event delegation and add the listener on the recipe element. Becuase the bookmark button does not exist by the time the page starts.
    this._parentElement.addEventListener('click', function (e) {
  ...
  _generateMarkupIngredients() {
    ...
    // ANOTHER way of creating ingredients HTML which is waht Jonas did. But I used the reduce() method :)
